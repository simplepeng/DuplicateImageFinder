...
import duplicateimagefinder.composeapp.generated.resources.copy_name
import duplicateimagefinder.composeapp.generated.resources.file_is_exists
...
private fun Content(
   ...
   DialogCard {
      Column(
         ...
         Text(
            text = stringResource(Res.string.file_is_exists)
         )
         AsyncImage(
            model = file.path,
         ...
         AppButton(
            ...
            Text(
               text = stringResource(Res.string.copy_name)
            )
         }
      }
   }
